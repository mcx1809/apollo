...
/*TEST_F(LMDLocalizationTest, InterpolateIMU) {
  // timestamp inbetween + time_diff is big enough(>0.001), interpolate
  {
    ...
    lmd_localizatoin_->InterpolateIMU(imu1, imu2, timestamp, &imu);
...
TEST_F(LMDLocalizationTest, ComposeLocalizationMsg) {
  // FLAGS_enable_map_reference_unify: false
  {
    ...
    lmd_localizatoin_->ComposeLocalizationMsg(gps, imu, &localization);
